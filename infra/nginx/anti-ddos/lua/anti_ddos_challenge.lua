...
localized.anti_ddos_table = {
	{
		...
		5, --5 second window
		150, --max 150 requests in 5s (Aumentado para Pentest / Scans UI)
		3600, --3600 seconds = 1 hour block time for ip flooding
		localized.ngx_HTTP_CLOSE, --444 connection reset 0 bytes per response
		...
		300, --if over 300 ip addresses are currently in the block list for flooding behaviour you are under attack
